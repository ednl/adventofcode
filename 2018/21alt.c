 ...
 *
 * Compile:
 *     cc -std=c17 -Wall -Wextra -pedantic 21alt.c
 * Enable timer:
 *     cc -std=gnu17 -O3 -march=native -mtune=native -DTIMER ../startstoptimer.c 21alt.c
 ...
 *     Mac Mini 2020 (M1 3.2 GHz)    : 2.64 ms
 *     Raspberry Pi 5 (2.4 GHz)      : 3.14 ms
 */
