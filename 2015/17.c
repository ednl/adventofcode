 ...
 *
 * Compile:
 *    clang -std=gnu17 -Ofast -march=native -Wall -Wextra 17.c ../combinations.c ../startstoptimer.c
 *    gcc   -std=gnu17 -Ofast -march=native -Wall -Wextra 17.c ../combinations.c ../startstoptimer.c
 * Get minimum runtime:
...
#include "../combinations.h"    // my own combinations function
