Prompted by /u/musifter 's [review of 2015 day 10](https://old.reddit.com/r/adventofcode/comments/1q8vjn0/2015_day_10_in_review_elves_look_elves_say/), I looked at my old solution for [Elves Look, Elves Say](https://adventofcode.com/2015/day/10) and realised I could massively improve the algorithm by using the "atomic elements" of the sequence as mentioned on the [Look-and-say Wikipedia page](https://en.wikipedia.org/wiki/Look-and-say_sequence#Cosmological_decay) (click 'show' on the Wikipedia page to see the table with elements).
