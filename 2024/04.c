...
#define MASK INT32_C(0x00ff00ff)  // blank out don't-care
...
// Rotate src (=grid or copy) left by 45 degrees: src(x,y) -> diag(x+y,N-1-x+y)
// Return pointer to first row with data long enough to hold search string
...
// Sum of "XMAS" and "SAMX" in rows of arr[rows][cols]
