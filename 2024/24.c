 ...
 *
 * Compile:
 *    clang -std=gnu17 -Wall -Wextra 24.c
 *    gcc   -std=gnu17 -Wall -Wextra 24.c
 * Enable timer:
 *    clang -DTIMER -O3 -march=native 24.c ../startstoptimer.c
 *    gcc   -DTIMER -O3 -march=native 24.c ../startstoptimer.c
