 ...
 *     Macbook Pro 2024 (M4 4.4 GHz)                    :  3.95 ms
 *     Mac Mini 2020 (M1 3.2 GHz)                       :  7.5 ms
 *     Raspberry Pi 5 (2.4 GHz)                         : 17.4 ms
 *     Macbook Air 2013 (Core i5 Haswell 4250U 1.3 GHz) : 17.8 ms
 *     Raspberry Pi 4 (1.8 GHz)                         : 44.5 ms
 */
