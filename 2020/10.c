 ...
 *    gcc   -std=gnu17 -O3 -march=native -Wall -Wextra 10.c ../startstoptimer.c
 * Get minimum runtime:
 ...
 *     ThinkPad Ubuntu (i5 8250U 1.8 GHz)  : 22 µs
 *     iMac 2013 (i5 Haswell 4570 3.2 GHz) : 34 µs
 *     Air 2013 (i5 Haswell 4250U 1.3 GHz) : 46 µs
 *     Raspberry Pi 4 (1.8 GHz)            : 77 µs
 */
